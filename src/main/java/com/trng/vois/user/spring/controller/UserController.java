package com.vodafone.vois.user.spring.controller;
...
import com.vodafone.vois.user.spring.bean.User;
import com.vodafone.vois.user.spring.service.UserService;
